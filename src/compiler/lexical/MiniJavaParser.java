...
import syntaxtree.*;
  ...
  Identifier name;
    jj_consume_token(CLASS);
    name = Identifier();
    c = ClassDeclarationEnd(name);
    {if (true) return c;}
    throw new Error("Missing return statement in function");
  }

  static final public ClassDecl ClassDeclarationEnd(Identifier name) throws ParseException {
  ...
  MethodDeclList ml;
    ...
    case EXTENDS:
      ...
      extendsId = Identifier();
      jj_consume_token(LBRACE);
      VarDeclarationList(vl);
      ml = MethodDeclarationList();
      jj_consume_token(RBRACE);
    {if (true) return new ClassDeclExtends(name, extendsId, vl, ml);}
      break;
    case LBRACE:
      jj_consume_token(LBRACE);
      VarDeclarationList(vl);
  ...
  static final public void VarDeclarationEnd(Type t, VarDeclList vl, StatementList stl) throws ParseException {
  Identifier id;
    singleVarDecl(t,vl,stl);
    label_6:
    while (true) {
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x400000,0x8c1200,0x10000000,0x1200,0x2000000,0x8c1200,0x0,0x1200,0x1200,0x8c0000,0x8c1200,0x0,0x0,0x0,0x0,0x0,0x0,0x8c0000,0x8c0000,0x8c0000,0x1200,0x0,0x0,0x60000000,0x60000000,0x80000000,0x0,0x0,0x0,0x10e000,0x200,0x10e000,0x20000,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x8200,0x200,0x8000,0x0,0x8200,0x800,0x8000,0x0,0x200,0x8200,0x800,0x8090,0x90,0x80,0x800,0x10,0x8200,0x200,0x8200,0x8000,0x2,0x8,0x0,0x0,0x0,0x4,0x1080,0x1080,0xc020,0x8000,0xc024,0x8000,0x800,};
   }
